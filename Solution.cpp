...
int main() {
  ...
  //None pruned values go into a new list to be sorted
  ...
  //Multi-process searching
  //Inspect elements in list
  //Get additive value subtracting the current index from the target sum
  //floor divide target sum by 2 to get the midpoint
  //Start Forward Search on index after mid point
